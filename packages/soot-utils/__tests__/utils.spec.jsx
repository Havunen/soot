...
describe("Utils", () => {
  describe("sortAttributes", () => {
    it("should return sorted attributes on HTML strings", () => {
      expect(
        sortAttributes(
          '<div zAttribute="test" aAttribute="soot" bAttribute="running">Soot <span fAttribute="huh" cAttr="last">is cool!</span></div>'
        )
      ).toBe(
        '<div aAttribute="soot" bAttribute="running" zAttribute="test">Soot <span cAttr="last" fAttribute="huh">is cool!</span></div>'
      );
    });
  });
