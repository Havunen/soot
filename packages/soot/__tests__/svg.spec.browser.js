...
describe("SVG (non-jsx)", () => {
  ...
  it("should set attributes correctly", () => {
    const template = val1 => <svg height={val1} />;
  ...
  it("should unset a namespaced attributes #2", () => {
    const template = val => <image xlink:href={val} />;
  ...
  it("should unset a namespaced attributes #3", () => {
    const template = val => (
      <svg xmlns="http://www.w3.org/2000/svg" xlink:href={val} />
    );
  ...
  it("should keep parent namespace (dynamic)", () => {
    let child,
      template = _child => (
        <svg xmlns="http://www.w3.org/2000/svg">{_child}</svg>
      );
  ...
  it("should set class attribute", () => {
    const template = val => <image class={val} />;
  ...
  it("should be possible to add className to SVG", () => {
    const template = () => (
      <svg xmlns="http://www.w3.org/2000/svg" className="class1 class2" />
    );
  ...
  it("should be possible to remove className from SVG", () => {
    const template = val => (
      <svg xmlns="http://www.w3.org/2000/svg" className={val} />
    );
