...
describe("Basic event tests", () => {
  ...
  it("should attach basic click events", done => {
    const template = val => <div id="test" onclick={val} />;
  ...
  it("should update events", () => {
    ...
    function App(d) {
      return <button onclick={onClick(d)}>{["Count ", d.count]}</button>;
    }
  ...
  it("should not trigger click at all if target is disabled", () => {
    ...
    function App(d) {
      return (
        <button disabled="disabled" onClick={onClick(d)}>
  ...
  it("should not leak memory", () => {
    ...
    function App() {
      return <button onsubmit={eventHandler}>{["1"]}</button>;
    }
  ...
  it("should not leak memory #2", () => {
    ...
    function App({ toggle }) {
      return <button onsubmit={toggle ? eventHandler : null}>{["1"]}</button>;
    }
  ...
  it("should not leak memory when child changes", () => {
    ...
    function smallComponent() {
      return <div onkeyup={eventHandler}>2</div>;
    }
    ...
    function App(children) {
      return <p onkeydown={eventHandler}>{children.slice(0)}</p>;
    }
  ...
  describe("Event Propagation", () => {
    it("Should stop propagating Synthetic event to document", done => {
      ...
      function SmallComponent() {
        return (
          <div onClick={eventHandler} id="tester">
            {2}
          </div>
        );
      }
    ...
    it("Should stop propagating Synthetic event to parentElement with synthetic event", done => {
      ...
      function SmallComponent() {
        return (
          <div id="parent" onClick={eventHandler2}>
            <div onClick={eventHandler} id="tester">
              2
            </div>
          </div>
    ...
    it("Should NOT stop propagating Synthetic event to parentElement with normal event", done => {
      ...
      function SmallComponent() {
        return (
          <div id="parent" onclick={eventHandler2}>
            <div id="tester" onClick={eventHandler}>
              2
            </div>
          </div>
        );
    ...
    // https://github.com/sootjs/soot/issues/979
    ...
    it("Should stop propagating normal event to normal event", done => {
      ...
      function SmallComponent() {
        return (
          <div onclick={eventHandler2} id="parent">
            <div onclick={eventHandler} id="tester">
              2
            </div>
          </div>
  ...
  describe("Event removal", () => {
    ...
    it("Should remove synthetic events when listener is nulled", () => {
      const spy = sinon.spy();
      render(
        <div>
          <div id="test" onClick={spy}>
    ...
    it("Should remove regular event when listener is nulled", () => {
      const spy = sinon.spy();
      render(
        <div>
          <div id="test" onclick={spy}>
      ...
      expect(container.querySelector("#test").onclick).toBeDefined();
      ...
      expect(container.querySelector("#test").onclick).toBe(null);
    });
  });
});
