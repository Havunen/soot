...
describe("Components (JSX)", () => {
  ...
  it("should render using setState even when there is no state", done => {
    class Foo extends Component {
      constructor(props) {
        super(props);
  ...
  describe("should render a component with a list that instantly changes", () => {
    class ChangeChildrenCount extends Component {
      ...
      render() {
        const content = [<button onClick={this.handleClick}>1</button>];
  ...
  describe("components should be able to use defaultProps", () => {
    ...
    it("should mount child component with its defaultProps", () => {
      const Parent = props => <div>{props.children.p.a}</div>;
      render(
        <Parent>
          <Comp1 c="C" />
        </Parent>,
    ...
    it("should as per React: Have childrens defaultProps set before children is mounted", () => {
      ...
      class Parent extends Component {
        render() {
          expect(this.props.children.p.a).toEqual(childrenPropertABeforeMount);
  ...
  describe("node change in updateComponent", () => {
    ...
    // it("Should render root level array - statefull", () => {
    //   class Comp1 extends Component {
    //     constructor(props) {
    //       super(props);
    //     }
    ...
    // });
    //
    // it('Should mount root level array - stateless', () => {
    //   const Comp1 = ({ foo }) => {
    //     if (foo) {
    //       return [<div>rendered1</div>, <div>rendered2</div>];
    //     }
    ...
    // });
    //
    // it("Should render root level array - stateless", () => {
    //   const Comp1 = ({ foo }) => {
    //     if (foo) {
    //       return [<div>rendered1</div>, <div>rendered2</div>];
    //     }
  ...
  describe("Asynchronous setStates", () => {
    it("Should not fail when parent component calls setState on unmounting children", done => {
      class Parent extends Component {
        ...
        render() {
          const content = [<span>{this.state.text}</span>];
