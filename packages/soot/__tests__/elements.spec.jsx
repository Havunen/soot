...
describe("Elements (JSX)", () => {
  ...
  it("should render a advanced div with static child and dynamic attributes", () => {
    ...
    render(
      <div className="Hello, Soot" id={attrs}>
        <div id={attrs} />
      </div>,
      container
    );
    ...
    expect(container.firstChild.childNodes.length).toBe(1);
    expect(container.firstChild.firstChild.nodeName).toBe("DIV");
    expect(container.firstChild.getAttribute("class")).toBe("Hello, Soot");
  ...
  it("should render a double div and a text node", () => {
    ...
    render(<div>{<div>Hello, Soot!</div>}</div>, container);

    expect(container.nodeName).toBe("DIV");
    expect(container.firstChild.nodeName).toBe("DIV");
    expect(container.firstChild.textContent).toBe("Hello, Soot!");
  });
  ...
  it('should render "className" attribute', () => {
    ...
    render(<div className="Soot rocks!" />, container);
    expect(container.firstChild.className).toEqual("Soot rocks!");
  ...
  it("should render a simple div with dynamic values and props", () => {
    ...
    expect(container.childNodes[0].childNodes[0].textContent).toEqual("Soot");
  ...
  it("should properly render a v with download attribute", () => {
    let val1;
  ...
  it("should render an iframe", () => {
    render(<iframe src="http://sootjs.org" />, container);
  ...
  it("should be able to construct v with Hooks, Events, Attributes defined", done => {
    function test() {}
  ...
  describe("should correctly handle nodes as quasi-immutable objects, like ReactElement does", () => {
    const a = V(VNodeFlags.HtmlElement, "div", null, "Hello world");
    const b = V(VNodeFlags.HtmlElement, "div", null, "This works!");
    const C = ({ children }) => (
      <div>
        {children}
        {children}
